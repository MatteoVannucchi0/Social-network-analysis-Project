...
from plot import get_plotly_node_traces, get_plotly_map, get_plotly_edge_traces
...
def compute_centrality(graph: nx.Graph, centrality: str = "degree", **kwargs) \
...
def compute_k_components(graph: nx.Graph, k=3, **kwargs) \
...
def compute_dominating_set(graph: nx.Graph, **kwargs) \
        -> typing.Tuple[dict[str, float], typing.Callable, typing.Callable]:
    """
